...
The maximum-clock captures above are benchmark-only comparisons of the exact
public tags. They did not rerun the functional suite or soak merely to produce
documentation.
...
The ESP archive uses the workflow's generic `esp32-s3` platform name; its
